...
class CircleFoot extends StatefulWidget {
  @override
  _CircleFootState createState() => _CircleFootState();
}

class _CircleFootState extends State<CircleFoot> {
  @override
  Widget build(BuildContext context) {
    ...
    void calculate() {
      setState(() {
        ...
        volume = (dia * width * height) - subtractwindowarea;
