...
class ConcreteFoot extends StatefulWidget {
  @override
  _ConcreteFootState createState() => _ConcreteFootState();
}

class _ConcreteFootState extends State<ConcreteFoot> {
  var length = 0,
      width = 0,
      height = 0,
      volume = 0,
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Center(
                child: Text(
                  'Dimension of Slab, Cube Concrete',
                  style: TextStyle(
                    color: Colors.white,
                    fontSize: 15,
                  ),
