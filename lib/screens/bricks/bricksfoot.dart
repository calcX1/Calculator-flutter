...
class BricksFoot extends StatefulWidget {
  @override
  _BricksFootState createState() => _BricksFootState();
}

class _BricksFootState extends State<BricksFoot> {
  var length = 0,
      width = 0,
      height = 0,
      volume = 0,
  ...
  Widget build(BuildContext context) {
    print(totalnumberofbricks);
    return Scaffold(
      backgroundColor: Colors.black,
      appBar: AppBar(
        title: Text('Calculate Bricks Quantity'),
      ),
      drawer: Drawer(),
      body: Hero(
        tag: "footb",
