...
class RecAreaMeter extends StatefulWidget {
  @override
  _RecAreaMeterState createState() => _RecAreaMeterState();
}

class _RecAreaMeterState extends State<RecAreaMeter> {
  @override
